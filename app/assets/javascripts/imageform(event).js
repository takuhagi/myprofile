$(function(){
  ...
  const buildFileField = ( index ) => {
    const html = `<div class="input-group">
                    <div class="js-file_group custom-file" data-index="${index}">
                      ...
                      name="event_profile[event_images_attributes][${index}][src]"
                      id="event_profile_event_images_attributes_${index}_src">
  ...
  $('#image-previews').on('click', '.cancel-img', function() {
    ...
    const relatedInput = document.getElementById(`event_profile_event_images_attributes_${targetIndex}_src`);
